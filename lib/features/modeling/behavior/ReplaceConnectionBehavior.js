...
function ReplaceConnectionBehavior(eventBus, modeling, bpmnRules) {
  ...
  this.postExecuted('element.updateProperties', function(event) {
    var context = event.context,
        ...
        defaultFlow = properties.default;

    if (defaultFlow && defaultFlow.conditionExpression) {
      modeling.updateProperties(defaultFlow, { conditionExpression: undefined });
    }

    // TODO(ricardo): remove itself as a default flow if that's the case
  });
}
